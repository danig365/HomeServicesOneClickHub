...
import BlueprintNotifications from "@/components/BlueprintNotifications";
const MONTHS = [
  "Jan",
  "Feb",
  "Mar",
...
export default function BlueprintScreen() {
  ...
  const { getSubscription, addPlanItem, updatePlanItem, removePlanItem, updateBlueprint } =
    useSubscription();
  ...
  // All useMemo hooks must be at top level
  const years = useMemo(() => {
  ...
  }, [fiveYearPlan, selectedYear, filterCategory]);
  ...
  const stats = useMemo(() => {
    if (!fiveYearPlan?.items)
      return { total: 0, completed: 0, planned: 0, inProgress: 0 };

    const yearItems = fiveYearPlan.items.filter(
  ...
  const handleDeleteItem = async (itemId: string, title: string) => {
    ...
    Alert.alert("Remove Item", `Remove "${title}" from the timeline?`, [
  ...
  const handleCompleteItem = async (item: YearlyPlanItem) => {
    ...
    Alert.alert("Mark as Completed", `Mark "${item.title}" as completed?`, [
      { text: "Cancel", style: "cancel" },
      {
        text: "Complete",
        onPress: async () => {
  ...
  const renderIcon = (iconName: string, size: number, color: string) => {
    ...
    return IconComponent ? (
      ...
      <Icons.Circle size={size} color={color} />
    );
  };

  // Property check after hooks
  if (!property) {
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>
            Please select a property first to view its timeline
          </Text>
          <TouchableOpacity
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>
            Create a blueprint first to start planning your property&apos;s future
          </Text>
          <TouchableOpacity
            style={styles.createButton}
            onPress={() => router.back()}
  ...
  const unreadCount = 5; // Replace with actual unread count from your notifications logic
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
                ...
                <View style={styles.monthHeader}>
                  <View style={styles.monthLabelContainer}>
                    <View
                      style={[
                        styles.monthDot,
                        hasItems && styles.monthDotActive,
                      ]}
                    />
                    <Text
                      style={[
                        styles.monthLabel,
                        hasItems && styles.monthLabelActive,
                      ]}
                    >
                      {month}
                    </Text>
                          ...
                          <View style={styles.itemContent}>
                            ...
                            {item.photos && item.photos.length > 0 && (
                              <View style={styles.itemPhotosSection}>
                                <Text style={styles.itemPhotosLabel}>
                                ...
                                >
                                  ...
                                  {item.photos.length > 5 && (
                                    <View style={styles.itemPhotoMore}>
                                      <Text style={styles.itemPhotoMoreText}>
                                        +{item.photos.length - 5}
                                      </Text>
                                    </View>
                                  )}
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerText}>
            Both homeowners and techs can add, edit, and complete items. All
            changes are tracked and both parties are notified.
          </Text>
        </View>
      </ScrollView>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalScroll}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setItemForm((prev) => ({ ...prev, title: text }))
                }
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setItemForm((prev) => ({ ...prev, description: text }))
                }
                ...
                {CATEGORIES.map((cat) => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      itemForm.category === cat.value && {
                        backgroundColor: cat.color + "20",
                        borderColor: cat.color,
                      },
                    ]}
                    onPress={() =>
                      setItemForm((prev) => ({ ...prev, category: cat.value }))
                    }
                  >
                    {renderIcon(
                      cat.icon,
                      18,
                      itemForm.category === cat.value ? cat.color : "#6B7280"
                    )}
                    <Text
                      style={[
                    ...
                    {MONTHS.map((month, index) => (
                      <TouchableOpacity
                        ...
                        style={[
                          ...
                          itemForm.month === index + 1 &&
                            styles.monthPickerButtonActive,
                        ]}
                        onPress={() =>
                          setItemForm((prev) => ({ ...prev, month: index + 1 }))
                        }
                      >
                        <Text
                          style={[
                            ...
                            itemForm.month === index + 1 &&
                              styles.monthPickerButtonTextActive,
                          ]}
                        >
                          {month}
                        </Text>
              ...
              <View style={styles.priorityButtons}>
                {(["low", "medium", "high"] as const).map((p) => (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setItemForm((prev) => ({ ...prev, priority: p }))
                    }
                  >
                    <Text
                      style={[
              ...
              <View style={styles.statusButtons}>
                {(
                  ["planned", "in-progress", "completed", "skipped"] as const
                ).map((s) => (
                  <TouchableOpacity
                    key={s}
                    style={[
                    ...
                    onPress={() =>
                      setItemForm((prev) => ({ ...prev, status: s }))
                    }
                  >
                    <Text
                      style={[
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setItemForm((prev) => ({ ...prev, estimatedCost: text }))
                }
                placeholder="e.g., $500"
                placeholderTextColor="#9CA3AF"
              />
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setItemForm((prev) => ({ ...prev, notes: text }))
                }
      ...
      <BlueprintNotifications
        ...
        onMarkAsRead={(id) => {
          if (!property || !blueprint) return;
          
          const updatedNotifications = blueprint.notifications?.map(n =>
            n.id === id ? { ...n, read: true } : n
          );

          updateBlueprint(property.id, {
            ...blueprint,
